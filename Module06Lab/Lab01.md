...
A homogenous sequence has data items all of the same type.  In many other languages the corresponding type is an array.  Example:
prime_numbers = (1, 3, 5, 7, 11, 13)

A heterogeneous sequence contains a data items of different type (or different business meaning).  Example:
...
1. Use a step to pick out all the even subscripted items ie [0], [2], [4], [6], etc (NOTE that the [0] entry contains the VALUE 1)
